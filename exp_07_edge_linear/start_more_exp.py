...
variables = [
    {"name": "8" ,"edge_linear": [8]},
    {"name": "16" ,"edge_linear": [16]},
    {"name": "32" ,"edge_linear": [32]},
    {"name": "64" ,"edge_linear": [64]},

    {"name": "16_8" ,"edge_linear": [16, 8]},
    {"name": "32_16" ,"edge_linear": [32, 16]},
    {"name": "64_32" ,"edge_linear": [64, 32]},
    {"name": "128_64" ,"edge_linear": [128, 64]},

    {"name": "16_8_4" ,"edge_linear": [16, 8, 4]},
    {"name": "32_16_8" ,"edge_linear": [32, 16, 8]},
    {"name": "64_32_16" ,"edge_linear": [64, 32, 16]},
    {"name": "128_64_32" ,"edge_linear": [128, 64, 32]},
...
EXPERIMENT_PARAMS["EdgeLinear"] = {linear}
"""
)
